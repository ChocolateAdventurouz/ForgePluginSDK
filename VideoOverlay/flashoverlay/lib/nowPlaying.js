    ...
    */
     ...
     */
    function UpdateTrackMetadata(title, artist, album, length, composer, year, genre, category, holdinterval) {
    ...
    function setDisplayFunction(invokeDisplayFn) {
